...
class AddDatetimeProjectRisks < ActiveRecord::Migration
	
  def self.up    	   	
	  add_column :project_risks, :detection_datetime, :date
	  add_column :project_risks, :closed_datetime, :date
	  add_column :project_risks, :resolution_datetime, :date
  end

  def self.down
	  remove_column :project_risks, :detection_datetime
	  remove_column :project_risks, :closed_datetime
	  remove_column :project_risks, :resolution_datetime
  end
