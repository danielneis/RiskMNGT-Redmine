...
class AddDatetimeProjectIncidents < ActiveRecord::Migration
	
  def self.up    	   	
	  add_column :project_incidents, :open_datetime, :date
	  add_column :project_incidents, :closed_datetime, :date
	  add_column :project_incidents, :resolution_datetime, :date
  end

  def self.down
	  remove_column :project_incidents, :open_datetime
	  remove_column :project_incidents, :closed_datetime
	  remove_column :project_incidents, :resolution_datetime
  end
