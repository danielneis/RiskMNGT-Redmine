...
class RenameProbabilityInProjectRisks < ActiveRecord::Migration
  def self.up    	
	  rename_column(:project_risks, :priority , :probability)
  end

  def self.down
	  rename_column(:project_risks, :probability, :priority)
  end
end
